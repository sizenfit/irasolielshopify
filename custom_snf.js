...
if(snfWindowWidth <= 767){
        ...
        var siemaBodyShape =jQuery(".11113");
        
        siemaBodyShape.owlCarousel({
            nav:true,
            startPosition: 0,
            items:3
        })
        
        siemaBodyShape.on('dragged.owl.carousel', function(property){
    ...
    var lsi = document.getElementById('left_shape_icon');
    var rsi = document.getElementById('right_shape_icon');

    lsi.style.display = "none";
    rsi.style.display = "block";

    siemaBodyShapeprev.addEventListener('click', function(){ 
        siemaBodyShape.trigger('prev.owl.carousel');
        lsi.style.display = "none";
        rsi.style.display = "block";
    });
    

    siemaBodyShapenext.addEventListener('click', function() {  
        siemaBodyShape.trigger('next.owl.carousel');
        rsi.style.display = "none";
        lsi.style.display = "block";
    });


    function seimaChangeShape(index){
        console.log("in seimaChange Style", + (index));
        siemaBodyShape.trigger('to.owl.carousel', index);
        rsi.style.display = "none";
        lsi.style.display = "block";
    }
}
